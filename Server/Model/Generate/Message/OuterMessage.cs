...
// 自己unitId
	...
	[ResponseType(nameof(A2C_GetServerIfos))]
	[Message(OuterOpcode.C2A_GetServerIfos)]
	[ProtoContract]
	public partial class C2A_GetServerIfos: Object, IRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(OuterOpcode.A2C_GetServerIfos)]
	[ProtoContract]
	public partial class A2C_GetServerIfos: Object, IResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
		...
		[ProtoMember(1)]
		public List<ServerInfoProto> ServerIfosList = new List<ServerInfoProto>();
	...
	[Message(OuterOpcode.C2A_CreaetRole)]
	[ProtoContract]
	public partial class C2A_CreaetRole: Object, IRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
